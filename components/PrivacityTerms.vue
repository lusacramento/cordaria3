<template>
	<div class="container privacity-terms mt-3">
		<div class="container privacity mb-3 ">

			<h2 class="mb-4 mt-3">🕵 Política Privacidade</h2>
			<p>
				A sua privacidade é importante para nós. É política do Cordaria App
				respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <NuxtLink
					to="/">Cordaria App</NuxtLink>, e outros
				sites
			...
			<p>
				...
				não podemos aceitar responsabilidade por suas respectivas <a href="https://politicaprivacidade.com/"
					rel="noopener noreferrer" target="_blank">políticas de privacidade</a>.
			</p>
			<p>
				Você é livre para recusar a nossa solicitação de informações
				pessoais, entendendo que talvez não possamos fornecer alguns dos serviços desejados.
			</p>
			<p>
			...
			<ul>
				<li>
					...
					Web e limitar o número de vezes que um determinado anúncio é exibido para você.
				</li>
				<li>
			...
			<p>
				...
				informação que o Cordaria App oferece no site e com caráter enunciativo, mas não limitativo:
			</p>
			<ul>
				<li>
				...
				<li>
					...
					xenofóbica, "bets" ou azar, qualquer tipo de pornografia ilegal, de apologia ao
					terrorismo ou contra os direitos humanos;
				</li>
				<li>
					Não causar danos aos sistemas físicos (hardwares) e lógicos
					(softwares) do Cordaria App, de seus fornecedores ou terceiros, para introduzir ou disseminar
			...
			<p>
				Esta política é efetiva a partir de <strong>{{ privacityTermsDate }}</strong>.
			</p>
		</div>
		<hr />
		<div class="terms-and-conditions mb-3 mt-1">
			...
			<h3>1. Termos</h3>
			<p>
				Ao acessar ao site <NuxtLink to="/">Cordaria App</NuxtLink>,
			...
			<p>
				...
				materiais (informações ou software) no site Cordaria App , apenas para visualização transitória
			...
			<ul>
				...
				<li>tentar descompilar ou fazer engenharia reversa de qualquer
					software contido no site Cordaria App;</li>
				<li>remover quaisquer direitos autorais ou outras notações de
					propriedade dos materiais; ou</li>
				<li>transferir os materiais para outra pessoa ou 'espelhe' os
					materiais em qualquer outro servidor.</li>
			</ul>
			<p>
				Esta licença será automaticamente rescindida se você violar alguma
				dessas restrições e poderá ser rescindida por Cordaria App a qualquer momento. Ao encerrar a
			...
			<ul>
				<li>Os materiais no site da Cordaria App são fornecidos 'como
					estão'. Cordaria App não oferece garantias, expressas ou implícitas, e, por este meio, isenta e
				...
				<li>Além disso, o Cordaria App não garante ou faz qualquer
			...
			<h3>4. Limitações</h3>
			<p>
				Em nenhum caso o Cordaria App ou seus fornecedores serão
				...
				Cordaria App, mesmo que Cordaria App ou um representante autorizado da Cordaria App tenha sido
			...
			<p>
				Os materiais exibidos no site da Cordaria App podem incluir erros
				técnicos, tipográficos ou fotográficos. Cordaria App não garante que qualquer material em seu site
				seja preciso, completo ou atual. Cordaria App pode fazer alterações nos materiais contidos em seu
				site a qualquer momento, sem aviso prévio. No entanto, Cordaria App não se compromete a atualizar os
				materiais.
			</p>
			<h3>6. Links</h3>
			<p>O Cordaria App não analisou todos os sites vinculados ao seu site e
				não é responsável pelo conteúdo de nenhum site vinculado. A inclusão de qualquer link não implica
				endosso por Cordaria App do site. O uso de qualquer site vinculado é por conta e risco do
				usuário.</p>
			<h3>7. Modificações</h3>
			<p>
				O Cordaria App pode revisar estes termos de serviço do site a
...
const privacityTermsDate = '15 de janeiro de 2025 às 22h11'
const termsAndConditionsDate = '15 de janeiro de 2025 às 22h11'
