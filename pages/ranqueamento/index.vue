		...
		<LayoutsHeader>
			<template #center>
				<div class="row d-flex justify-content-center">
					<div class="col">
						<button type="button" class="btn btn-acoustic-guitar d-flex justify-content-center"
					...
					<div class="col">
						<button type="button" class="btn btn-electric-guitar d-flex justify-content-center"
					...
					<div class="col">
						<button type="button" class="btn btn-bass d-flex justify-content-center"
					...
					<div class="col">
						<button type="button" class="btn btn-cavaco d-flex justify-content-center"
